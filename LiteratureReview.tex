...
\cite{bioref:Greulich-growthDependentAntibiotics} constructed a simple computational model which investigated how a bacterial population evolved along pathways 
...
were spent replicating the results and techniques found in \cite{bioref:Greulich-growthDependentAntibiotics}.  Discussion was had
...
Following on from this, work will continue on the multispecies model.  The current version 
